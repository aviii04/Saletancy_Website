...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Menu CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" rel="stylesheet">
    <!-- toast CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- morris CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- chartist CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/chartist-js/dist/chartist.min.css" rel="stylesheet">
    <link href="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
    <!-- animation CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/css/animate.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/css/style.css" rel="stylesheet">
    <!-- color CSS -->
    <link href="<?php echo base_url() ?>assest/ad_assest/css/colors/default.css" id="theme" rel="stylesheet">
...
<body class="fix-header">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part" style="background-color: #2F323E;">
                    ...
                    <a class="logo" href="index.html"><b>SALETANCY</b>                    
                    </span> </a>
                </div>
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="<?php echo base_url() ?>assest/ad_assest/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
    ...
    <script src="<?php echo base_url() ?>assest/ad_assest/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
    <!--slimscroll JavaScript -->
    <script src="<?php echo base_url() ?>assest/ad_assest/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo base_url() ?>assest/ad_assest/js/waves.js"></script>
    <!--Counter js -->
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!-- chartist chart -->
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/chartist-js/dist/chartist.min.js"></script>
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
    <!-- Sparkline chart JavaScript -->
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="<?php echo base_url() ?>assest/ad_assest/js/custom.min.js"></script>
    <script src="<?php echo base_url() ?>assest/ad_assest/js/dashboard1.js"></script>
    <script src="<?php echo base_url() ?>assest/ad_assest/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
</body>
